...
$file_path = '../uploads/surat_masuk/' . $surat['file_surat'];
...
<body>
    <div class="pdf-header">
        ...
        <div class="header-right">
            <a href="surat-masuk.php" class="btn-header">
    ...
    <script>
        ...
        let scale = 1.5; // Scale ditingkatkan untuk preview lebih tajam
        let rotation = 0;
        ...
        // Render page dengan device pixel ratio untuk layar retina/high-DPI
        function renderPage(num) {
            pageRendering = true;
            pdfDoc.getPage(num).then(function(page) {
                // Dapatkan device pixel ratio untuk kompensasi layar high-DPI
                const devicePixelRatio = window.devicePixelRatio || 1;

                // Viewport dengan scale yang sudah dikompensasi dengan pixel ratio
                const viewport = page.getViewport({
                    scale: scale * devicePixelRatio,
                    rotation: rotation
                });

                // Set ukuran canvas sesuai viewport (resolusi tinggi)
                canvas.height = viewport.height;
                canvas.width = viewport.width;

                // Set ukuran display CSS (lebih kecil dari canvas untuk ketajaman)
        ...
        // Print - Buka PDF asli di tab baru untuk print
